...
- User page controls for searchable table listing, Add user modal creation, create/edit fields, role/status selection, password entry, User audit placement, audit report export, audit events, and backend API wiring.
