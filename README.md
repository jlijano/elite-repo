...
- User page-specific styling and client behavior live in `web/public/user-page.css` and `web/public/user-page.js`; the shared admin shell remains in `web/public/admin.css` and `web/public/admin.js`.
